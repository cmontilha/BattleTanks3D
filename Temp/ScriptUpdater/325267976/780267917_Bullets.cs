...
public class Bullets : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (rb == null)
        {
            Debug.LogError("Rigidbody não foi encontrado na Bullets!");
            return;
        }
    ...
    {
        Debug.Log("Bullets colidiu com: " + collision.gameObject.name); // Log para monitorar com o que a Bullet colidiu
        ...
        // Destrói a bullet se colidir com um inimigo
        if (collision.gameObject.name == "Enemy")
        {
            Debug.Log("Colidiu com Enemy. Destruindo Bullet.");
            Destroy(gameObject);
        }

        // Reinicia a cena se a bullet colidir com o tanque
        if (collision.gameObject.name == "Tank")
        {
            Debug.Log("Colidiu com Tank. Reiniciando cena.");
